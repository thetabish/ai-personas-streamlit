...
echo "======================================================================${NC}"
echo ""
echo -e "${CYAN}📄 Die Ergebnisse wurden gespeichert als:${NC}"
echo -e "${YELLOW}   - results.json (JSON-Format)${NC}"
echo -e "${YELLOW}   - results.md (Markdown-Format)${NC}"
echo ""
echo -e "${CYAN}🔄 Um weitere Interviews zu führen:${NC}"
echo -e "${YELLOW}   $PYTHON_CMD interview.py --questions questions.json${NC}"
echo ""
echo -e "${CYAN}📝 Um eigene Fragen zu verwenden:${NC}"
echo -e "${YELLOW}   1. Bearbeiten Sie questions.json${NC}"
